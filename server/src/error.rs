...
pub enum Error {
	...
	PkarrResolveError(pkarr::errors::ResolveError),
...
impl From<pkarr::errors::ResolveError> for Error {
	#[inline(always)]
	fn from(value: pkarr::errors::ResolveError) -> Self {
		Self::PkarrResolveError(value)
	}
}
